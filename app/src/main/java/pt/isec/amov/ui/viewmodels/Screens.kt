...
enum class Screens(display: String, val showAppBar: Boolean){
    ...
    POINT_OF_INTEREST_DETAILS("LocalDetails", true), //Página com detalhes dos locais de interesse
    ...
    POINT_OF_INTEREST("Local", true), //Página que lista todas as localizações
